...
import { Body, Text, CardItem, Card } from "native-base";
...
export default class WorkoutScreen extends React.Component {
  ...
  renderUsers = () => {
    ...
    return User.User.Users.map((item, i) => {
      if (i < this.state.currentIndex) {
        ...
        return (
          <Animated.View
            ...
            key={item.id} style={[this.rotateAndTranslate, { height: SCREEN_HEIGHT, width: SCREEN_WIDTH, padding: 10, position: 'absolute' }]}>
            ...
            <Card style={{ flex: 0, height: "40%", }}>
              <Image style={{ height: "50%", width: "100%" }} source={item.uri} />
              <CardItem>
                <Body>
